...
# subset data to young adults age 18 to 25 who have smoked in the past 12
# months
sub1 = data[(data['AGE'] >= 18) & (
    data['AGE'] <= 25) & (data['CHECK321'] == 1)]
...
# Creating a secondary variable multiplying the days smoked/month and the
...
data['incomeperperson'] = data['incomeperperson'].convert_objects(
    convert_numeric=True)
data['internetuserate'] = data['internetuserate'].convert_objects(
    convert_numeric=True)
...
print(
    scipy.stats.pearsonr(
        data_clean['urbanrate'],
        data_clean['internetuserate']))
